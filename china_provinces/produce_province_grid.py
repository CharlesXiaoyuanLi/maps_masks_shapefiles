...
# 中文
# Read ncfile for lat and lon
nc_file = 'wrfout_d01_2010-06-30_12:00:00'
...
fnm = check_output("ls /home/charleslxy/Documents/China_Solar_Potential/cn_province/*txt", shell=True)
...
f = open("cn_province_lambert_"+str(nlat)+"x"+str(nlon)+".txt","w+")
for i in range(nlat):
    for j in range(nlon):
